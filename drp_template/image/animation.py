...
from drp_template.image.rendering import get_lighting_preset
...
def create_rotation_animation(
    ...
    """Create a rotating animation of 3D volume rendering and save to file."""
    if pv is None:
    ...
    if show_legend:
        plotter.add_legend(size=legend_size, loc=legend_position, face='rectangle', bcolor='white', border=True)
